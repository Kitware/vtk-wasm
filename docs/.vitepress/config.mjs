        ...
        "/guide/": [
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: "Standalone Session",
                link: "/guide/js/standalone-session",
              },
              { text: "Primer on VTK.wasm", link: "/guide/js/primer" },
              { text: "Remote Session", link: "/guide/js/remote-session" },
              { text: "TypeScript types", link: "/guide/js/typescript" },
              {
                text: "Adding VTK.wasm to a Project",
                link: "/guide/js/integration",
              },
            ],
          },
          {
